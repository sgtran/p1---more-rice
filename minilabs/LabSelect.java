...
public class LabSelect {
    ...
    private static String[] options = {"1. Factorial - Alex", "2. Fibonacci - Andrew", "3. GCD - Sean", "4. Binary Search - Kevin"};
    ...
    public static void main(String args[]) {
        ...
        switch(selection){
            ...
            case 3:
                ...
                break;
            case 4:
                BinarySearchController binary = new BinarySearchController();
                break;
        }
    }
